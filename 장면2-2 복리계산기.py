...
def fourthButtonTapped():
    ...
    label9 = Label(window, text="원리금(원)", font=("Arial", 18, "bold"), fg="white", bg="blue")
    label9.place(x = 330, y = 425)
    label10 = Label(window, text=int(total), font=("Arial", 18, "bold"), fg="white", bg="blue")
    label10.place(x = 330, y = 475)
    label2.config(text = "↪ " + str(label8.cget("text"))+ "년 후 당신의 원리금은\n"+ str(label10.cget("text")) + "원 입니다")
    label2.place(x = 50, y = 520)
